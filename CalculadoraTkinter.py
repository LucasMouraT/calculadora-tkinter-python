...
class Calculadora:
    def __init__(self, toplevel):
        ...
        # Botão subtrair
        subtrair = Button(self.frame4, font=fonte1,
                          text='-', command=self.subtrair)
        subtrair.pack(side=LEFT)

        # Botão multiplicar
        multiplicar = Button(self.frame4, font=fonte1,
                             text='*', command=self.multiplicar)
        multiplicar.pack(side=LEFT)

        # Botão dividir
        dividir = Button(self.frame4, font=fonte1,
                         text='/', command=self.dividir)
        dividir.pack(side=LEFT)

        # Botão Seno
        seno = Button(self.frame4, font=fonte1, text='sin', command=self.seno)
        seno.pack(side=LEFT)

        # Botão Cosseno
        cosseno = Button(self.frame4, font=fonte1,
                         text='cos', command=self.cosseno)
        cosseno.pack(side=LEFT)

        # Botão tangente
        tangente = Button(self.frame4, font=fonte1,
                          text='tan', command=self.tangente)
        tangente.pack(side=LEFT)
        ...
        # Botão Limpar
        limpar = Button(self.frame6, font=fonte1,
                        text='Limpar', command=self.limpar)
